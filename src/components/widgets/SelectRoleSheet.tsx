...
interface SelectRoleSheetProps {
  label?: string;
...
const SelectRoleSheet: React.FC<SelectRoleSheetProps> = ({
  ...
  return (
    <>
      <TouchableOpacity
        ...
        className="flex-row items-center px-4 py-3 rounded-lg border self-start"
        style={{
...
export default SelectRoleSheet;
