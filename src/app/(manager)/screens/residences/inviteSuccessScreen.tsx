    ...
    <ThemedView className="flex-1">
      ...
      >
        ...
        {params.residenceName && (
          <View
            className="rounded-xl py-4 px-6 mt-4 mx-1 flex-row items-center justify-between"
          ...
          >
            <View>
              ...
              {params.block && params.floorNumber && (
            ...
            <View className="items-end">
              ...
              {params.phone && (
                <ThemedTextSecondary className="font-uber-move-regular text-sm mt-0.5">
                  {params.phone}
                </ThemedTextSecondary>
              )}
            </View>
        ...
        <View
          ...
          style={{ marginTop: 2, marginBottom: insets.bottom + 16 }}
        >
          <View>
            <View className="flex-row items-center mt-6 mx-4 justify-center">
          ...
          <View className="items-center mt-4">
            ...
            <View className="mt-4 justify-between flex items-center">
              ...
              <TouchableOpacity
                className="flex-row items-center mt-2 border-b px-2 py-1 rounded-md"
          ...
          <View className="flex-row-reverse justify-center gap-x-4 mt-6">
            <TouchableOpacity
              onPress={handleUniversalShare}
              className="flex-row items-center justify-center py-2 px-4 rounded-sm w-1/3"
            >
              <ShareIcon width={20} height={20} color={colors.text} />
              <ThemedText className="ml-5 font-uber-move-medium text-base">
                More share options
              </ThemedText>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={handleShareViaSms}
              className="flex-row items-center justify-center py-4 px-4 rounded-md w-1/2"
